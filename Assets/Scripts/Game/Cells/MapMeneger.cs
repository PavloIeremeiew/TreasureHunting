...
public class MapMeneger : MonoBehaviour
{
    ...
    private HowFarExit _howFarExit;
    ...
    private void Awake()
    {
        ...
        _exitPosition= _generator.GeneraitExit(_cells, Constants.STEP, Constants.EXIT_WAY_COUNT);
    ...
    private void Start()
    {
        ...
        _howFarExit= gameObject.AddComponent<HowFarExit>();
        _howFarExit.Setter(_player.transform, _exitPosition, Constants.STEP,Constants.SIZE);
    }
}
